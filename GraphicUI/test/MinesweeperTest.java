...
public class MinesweeperTest {
    ...
    //***Due to no longer using a textual representation, method:
    //   'revealField()' has been removed. Test still prove that 
    //   minesweeper class functions properly, but testing must 
    //   be made using Part2 submission***
    @Test
